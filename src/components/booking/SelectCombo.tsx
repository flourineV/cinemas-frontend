        ...
        return (
          ...
          >
            ...
            <div className="flex flex-col justify-between flex-1">
              <div>
                <span className="font-bold text-xl text-white">{c.name}</span>
                {c.description && (
                  <div className="text-gray-300 text-md font-light mt-2">
                    {c.description}
                  </div>
                )}
              ...
              <div className="flex items-center gap-5 mt-3">
                ...
                <button
                  ...
                  onClick={() => handleChange(c.id, 1)}
                  className="w-10 h-10 flex items-center justify-center rounded-full 
                  bg-green-600 hover:bg-green-700 text-white transition active:scale-95"
                >
                  <Plus size={20} />
                </button>
              </div>
