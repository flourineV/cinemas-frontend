        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-slate-800 rounded-lg p-6">
              <h2 className="text-xl font-semibold text-white mb-4">Quản lý người dùng</h2>
            ...
            {/* Cinema Management */}
            <div className="bg-slate-800 rounded-lg p-6">
              <h2 className="text-xl font-semibold text-white mb-4">Quản lý rạp</h2>
            ...
            {/* Movie Management */}
            <div className="bg-slate-800 rounded-lg p-6">
              <h2 className="text-xl font-semibold text-white mb-4">Quản lý phim</h2>
            ...
            {/* Schedule Management */}
            <div className="bg-slate-800 rounded-lg p-6">
              <h2 className="text-xl font-semibold text-white mb-4">Lịch chiếu tổng</h2>
            ...
            {/* Financial Reports */}
            <div className="bg-slate-800 rounded-lg p-6">
              <h2 className="text-xl font-semibold text-white mb-4">Báo cáo tài chính</h2>
            ...
            <div className="bg-slate-800 rounded-lg p-6">
              <h2 className="text-xl font-semibold text-white mb-4">Quản lý khuyến mãi</h2>
            ...
            {/* System Settings */}
            <div className="bg-slate-800 rounded-lg p-6">
              <h2 className="text-xl font-semibold text-white mb-4">Cài đặt hệ thống</h2>
            ...
            {/* Analytics */}
            <div className="bg-slate-800 rounded-lg p-6">
              <h2 className="text-xl font-semibold text-white mb-4">Phân tích dữ liệu</h2>
            ...
            <div className="bg-slate-800 rounded-lg p-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-slate-700 pb-2">
                  <span className="text-gray-300">Người dùng mới đăng ký: user123@example.com</span>
                  <span className="text-gray-400 text-sm">5 phút trước</span>
                </div>
                <div className="flex items-center justify-between border-b border-slate-700 pb-2">
                  <span className="text-gray-300">Phim mới được thêm: Avatar 3</span>
                  <span className="text-gray-400 text-sm">1 giờ trước</span>
                </div>
                <div className="flex items-center justify-between border-b border-slate-700 pb-2">
                  <span className="text-gray-300">Lịch chiếu được cập nhật cho rạp CGV Landmark</span>
                  <span className="text-gray-400 text-sm">2 giờ trước</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-300">Khuyến mãi "Thứ 3 vui vẻ" được kích hoạt</span>
